...
def main() -> int:
    ...
    parser.add_argument("--findings", default=".agents/review-intake/review-findings.jsonl")
    parser.add_argument("--queue", default=".agents/review-intake/next-work.queue.json")
    parser.add_argument("--state", default=".agents/review-intake/review-intake.state.json")
