...
Pipe into gh CLI to post:
  python scripts/post_review_resolution.py --finding RF-1 --task NW-1 \
    --agent Sentinel --status Resolved --files src/a.py --validation "pytest" \
