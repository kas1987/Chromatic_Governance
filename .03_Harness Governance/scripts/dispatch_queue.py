...
def main() -> int:
    ...
    for item in ready_items:
        entry = dispatch_item(item, Path(args.missions_dir), Path(args.dispatch_log), args.dry_run)
    ...
    print(json.dumps({"dispatched": len(dispatched), "dry_run": args.dry_run}, indent=2))
    return 0
