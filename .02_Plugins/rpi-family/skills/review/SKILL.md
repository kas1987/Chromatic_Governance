...
> Extended review criteria and checklist: [`references/support.md`](references/support.md)
...
| Problem | Cause | Fix |
|---------|-------|-----|
| Review misses context about a module | File not in diff but critical to understand | Pass `--context-files src/auth/` to include adjacent files |
